    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="POST" action="<?= BASEURL ?>/penjadwalan/pemberian_pakan_insert/<?= $data['jadwal']['id_jadwal'] ?>">
                                ...
                                <tbody>
                                    <?php foreach ($data['bibit'] as $bibit) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <select class="custom-select d-block w-100" id="jenis_pakan-<?= $nutrisi['kode_bibit'] ?>" name="kode_pakan[<?= $bibit['kode_bibit'] ?>]" required>
                                            ...
                                            <td><input type="number" class="form-control" name="qty_pakan[<?= $bibit['kode_bibit'] ?>]"></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
